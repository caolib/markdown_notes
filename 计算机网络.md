...
<img src="https://s2.loli.net/2025/04/15/BGba1wXvP8gJMjr.png" alt="计算机网络分类" title='计算机网络的分类' />
...
<img src="https://s2.loli.net/2025/04/15/Gp76KrC5DImWYza.png" title="网络" style="zoom:80%;" />
...
<img src="https://s2.loli.net/2025/04/15/r3hds4vZn2tJGRK.png" title="互连网络就是网络的网络" style="zoom:80%;" />
...
<img src="https://s2.loli.net/2025/04/15/F23IxilOtfKMApJ.png" style="zoom: 67%;" />
...
<img src="https://s2.loli.net/2025/04/15/RNLpfOwAnSGuo7J.png" title="ISP结构的互联网" style="zoom: 67%;"/>

### 1.4 电路交换和分组交换

#### 1.4.1 电路交换

![电路交换](https://s2.loli.net/2025/04/15/hyd7zxNVTZuP6L8.png)
...
<img src="https://s2.loli.net/2025/04/15/nytgKkQeD2NOamW.png" alt="分组交换" style="zoom: 80%;" />
...
![交换方式对比](https://s2.loli.net/2025/04/15/yDVd7AeM15IN2kP.png)
...
<img src='https://s2.loli.net/2025/04/15/QHOuqGFdSsKrv8h.png' alt='速率'>
...
2. 计算机网络中，带宽表示网络某通道传输能力，即<mark>最高数据率</mark>,单位为<mark>比特每秒</mark>（bit/s）
   ...
   <img src="https://s2.loli.net/2025/04/15/TuH2RSK3qE1lPQg.png" alt='带宽'/>
...
<img src="https://s2.loli.net/2025/04/15/dkLInEVf8JjuKGT.png" alt='时延'/>

![时延](https://s2.loli.net/2025/04/15/3iYnCT2SOGJmyhR.png)

#### 5. 时延带宽积 往返时间 利用率 丢包率

<img src="https://s2.loli.net/2025/04/15/nghY6Z1EwjiDGco.png" alt="" style="zoom:;" />
...
![常见的计算机网络分层体系结构](https://s2.loli.net/2025/04/15/gIWHBZ2mQevjVRb.png)

#### 1.6.3 原理体系结构

> 我们学习的是具有五层协议的原理体系结构

![原理体系结构](https://s2.loli.net/2025/04/15/EWs7SmRbnj3dApN.png)
...
![实体、协议和服务](https://s2.loli.net/2025/04/15/ljHnU52YxQfLOmC.png)

![TCP/IP参考模型中的协议](https://s2.loli.net/2025/04/15/G6ZiXr7BKQfPL2v.jpg)

### 1.7 相关习题

![](https://s2.loli.net/2025/04/15/gRtPWhiE5G1nYLm.png)

![](https://s2.loli.net/2025/04/15/gmbtj8c9ICLuW6a.png)
...
![物理层的基本概念](https://s2.loli.net/2025/04/15/EjYINlaAJe4UCyP.png)

### 2.2 数据通信的基础知识

#### 2.2.1 数据通信的基础知识

![](https://s2.loli.net/2025/04/15/4vihGXCrNdwfkmA.png)
...
![编码与调制](https://s2.loli.net/2025/01/05/VXEAhmTHlF34b1y.png)

2. 常用编码方式

![常用编码方式](https://s2.loli.net/2025/04/15/82HVezjCYEyAuQm.png)

3. 基本的调制方法

![基本的调制方法](https://s2.loli.net/2025/04/15/3pQq1u4JGDlovVX.png)
...
![信号失真](https://s2.loli.net/2025/04/15/HJYCpQB1PO8yufD.png)

>  [!important] 
>
>  <mark>奈式准则</mark>

![奈式准则](https://s2.loli.net/2025/04/15/YOTD7Z9yiXgIpVu.png)
...
![香农公式](https://s2.loli.net/2025/04/15/NK36mABuZExn18R.png)
...
![并行传输和串行传输](https://s2.loli.net/2025/04/15/LjqeW2IC8fcO5wF.png)

2. 异步传输和同步传输

> 异步传输<mark>字节之间异步</mark>，但是要添加<mark>开始码</mark>和<mark>停止码</mark>作为引导

<img src="https://s2.loli.net/2025/04/15/oiEK3j5uLAPye2s.png" alt="异步传输和同步传输"  />

3. 单工、半双工和全双工通信

![单工、半双工和全双工通信](https://s2.loli.net/2025/04/15/ZH5uW6UIG7RDgqn.png)
...
![双绞线](https://s2.loli.net/2025/04/15/zXs9QHvB7u3kZqF.png)

3. **光纤**

![光纤](https://s2.loli.net/2025/04/15/fHSa1p7XtRqcn5T.png)

#### 2.3.2 非导引型传输媒体

1. **微波**

![微波](https://s2.loli.net/2025/04/15/9olysrDMbHkVfLq.png)
...
![89af6958d4fa2d26fa9f7a3d711032cb](https://s2.loli.net/2025/04/15/6jRS4gTkNtGU2oV.png)

### 2.4 信道复用技术

> 复用：当网络中传输媒体的传输容量大于多条单一信道传输的总通信量时，可利用复用技术<mark>在一条物理线路上建立多条通信信道</mark>来共享传输媒体的带宽。

<img src="https://s2.loli.net/2025/04/15/3D2Y1EpbnOFyU7W.png" alt="信道复用" style="zoom:80%;" />
...
<img src="https://s2.loli.net/2025/04/15/mT9OHV72xG4WZnR.png" style="zoom: 67%;" />
...
<img src="https://s2.loli.net/2025/04/15/6FujPREaU1vpmst.png" alt="时分复用" style="zoom: 67%;" />
...
![码分复用](https://s2.loli.net/2025/04/15/Saw7cXH1RKbYljM.png)
...
![54cb1e479b1bb4e0db17cedc1ab76e6e](https://s2.loli.net/2025/04/15/oGTWbBtr7kAYDZq.png)
